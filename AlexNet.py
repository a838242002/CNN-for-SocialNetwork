...
def inference_op(input_op, keep_prob):
	...
	pool3 = mpool_op(conv3, name="pool3", kh=3, kw=3, dw=2, dh=2)

	conv4 = conv_op(pool3, name="conv4", kh=3, kw=3, n_out=256, dw=2, dh=2, p=p)
	pool4 = mpool_op(conv4, name="pool4", kh=3, kw=3, dw=2, dh=2)
	...
	reshape1 = tf.reshape(pool1, [-1, flattened_shape], name="resh1")
